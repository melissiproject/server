...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Droplet.content_sha256'
        db.add_column('mlscommon_droplet', 'content_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Droplet.patch_sha256'
        db.add_column('mlscommon_droplet', 'patch_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'DropletRevision.content_sha256'
        db.add_column('mlscommon_dropletrevision', 'content_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'DropletRevision.patch_sha256'
        db.add_column('mlscommon_dropletrevision', 'patch_sha256', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Droplet.content_sha256'
        db.delete_column('mlscommon_droplet', 'content_sha256')

        # Deleting field 'Droplet.patch_sha256'
        db.delete_column('mlscommon_droplet', 'patch_sha256')

        # Deleting field 'DropletRevision.content_sha256'
        db.delete_column('mlscommon_dropletrevision', 'content_sha256')

        # Deleting field 'DropletRevision.patch_sha256'
        db.delete_column('mlscommon_dropletrevision', 'patch_sha256')
    ...
    models = {
        ...
        'mlscommon.droplet': {
            ...
            'content_sha256': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
        ...
        'mlscommon.share': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'share_parent'", 'to': "orm['mlscommon.Cell']"}),
