...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Share.created'
        db.add_column('mlscommon_share', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 6, 17, 21, 44, 45, 283917), blank=True), keep_default=False)

        # Adding field 'Share.updated'
        db.add_column('mlscommon_share', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 6, 17, 21, 44, 49, 717006), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Share.created'
        db.delete_column('mlscommon_share', 'created')

        # Deleting field 'Share.updated'
        db.delete_column('mlscommon_share', 'updated')
    ...
    models = {
        ...
        'mlscommon.cellrevision': {
            'Meta': {'unique_together': "(('cell', 'number'),)", 'object_name': 'CellRevision'},
        ...
        'mlscommon.dropletrevision': {
            'Meta': {'unique_together': "(('droplet', 'number'),)", 'object_name': 'DropletRevision'},
