...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellRevision.number'
        db.add_column('mlscommon_cellrevision', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'DropletRevision.number'
        db.add_column('mlscommon_dropletrevision', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellRevision.number'
        db.delete_column('mlscommon_cellrevision', 'number')

        # Deleting field 'DropletRevision.number'
        db.delete_column('mlscommon_dropletrevision', 'number')
