...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Share.mode'
        db.add_column('mlscommon_share', 'mode', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)

        # Adding field 'Share.name'
        db.add_column('mlscommon_share', 'name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=500), keep_default=False)

        # Adding field 'Share.parent'
        db.add_column('mlscommon_share', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='share_parent', to=orm['mlscommon.Cell']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Share.mode'
        db.delete_column('mlscommon_share', 'mode')

        # Deleting field 'Share.name'
        db.delete_column('mlscommon_share', 'name')

        # Deleting field 'Share.parent'
        db.delete_column('mlscommon_share', 'parent_id')
