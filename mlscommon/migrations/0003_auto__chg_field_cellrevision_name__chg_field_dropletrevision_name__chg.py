...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CellRevision.name'
        db.alter_column('mlscommon_cellrevision', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'DropletRevision.name'
        db.alter_column('mlscommon_dropletrevision', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'DropletRevision.cell'
        db.alter_column('mlscommon_dropletrevision', 'cell_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlscommon.Cell'], null=True))


    def backwards(self, orm):
        
        # Changing field 'CellRevision.name'
        db.alter_column('mlscommon_cellrevision', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=500))

        # Changing field 'DropletRevision.name'
        db.alter_column('mlscommon_dropletrevision', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=500))

        # Changing field 'DropletRevision.cell'
        db.alter_column('mlscommon_dropletrevision', 'cell_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mlscommon.Cell']))
