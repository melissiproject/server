...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Share.parent'
        db.alter_column('mlscommon_share', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mlscommon.Cell']))


    def backwards(self, orm):
        
        # Changing field 'Share.parent'
        db.alter_column('mlscommon_share', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mlscommon.Cell']))
