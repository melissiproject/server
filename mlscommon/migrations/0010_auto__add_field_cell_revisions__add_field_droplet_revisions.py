...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cell.revisions'
        db.add_column('mlscommon_cell', 'revisions', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Droplet.revisions'
        db.add_column('mlscommon_droplet', 'revisions', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cell.revisions'
        db.delete_column('mlscommon_cell', 'revisions')

        # Deleting field 'Droplet.revisions'
        db.delete_column('mlscommon_droplet', 'revisions')
    ...
    models = {
        ...
        'mlscommon.cell': {
            ...
            'revisions': ('django.db.models.fields.PositiveIntegerField', [], {}),
