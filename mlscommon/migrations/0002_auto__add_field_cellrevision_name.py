...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellRevision.name'
        db.add_column('mlscommon_cellrevision', 'name', self.gf('django.db.models.fields.CharField')(default=' ', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellRevision.name'
        db.delete_column('mlscommon_cellrevision', 'name')
