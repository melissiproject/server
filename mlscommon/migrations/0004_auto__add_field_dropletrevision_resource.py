...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DropletRevision.resource'
        db.add_column('mlscommon_dropletrevision', 'resource', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mlscommon.UserResource']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DropletRevision.resource'
        db.delete_column('mlscommon_dropletrevision', 'resource_id')
