...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DropletRevision.content_size'
        db.add_column('mlscommon_dropletrevision', 'content_size', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'DropletRevision.patch_size'
        db.add_column('mlscommon_dropletrevision', 'patch_size', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DropletRevision.content_size'
        db.delete_column('mlscommon_dropletrevision', 'content_size')

        # Deleting field 'DropletRevision.patch_size'
        db.delete_column('mlscommon_dropletrevision', 'patch_size')
