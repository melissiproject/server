...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.quota'
        db.delete_column('mlscommon_userprofile', 'quota')

        # Adding field 'UserProfile.personal_quota'
        db.add_column('mlscommon_userprofile', 'personal_quota', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.quota'
        db.add_column('mlscommon_userprofile', 'quota', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Deleting field 'UserProfile.personal_quota'
        db.delete_column('mlscommon_userprofile', 'personal_quota')
    ...
    models = {
        ...
        'mlscommon.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'personal_quota': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'quota_limit': ('django.db.models.fields.PositiveIntegerField', [], {'default': '102400'}),
            'shared_quota': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
