...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.shared_quota'
        db.add_column('mlscommon_userprofile', 'shared_quota', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.shared_quota'
        db.delete_column('mlscommon_userprofile', 'shared_quota')
